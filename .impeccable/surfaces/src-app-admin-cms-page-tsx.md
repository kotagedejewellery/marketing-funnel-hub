...
STORY: An admin sees the current site identity, active branch and WhatsApp-button counts, recent changes, and direct routes to editing. The interface should make the next legitimate action obvious without a fake KPI.

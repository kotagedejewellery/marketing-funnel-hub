...
- **Google review cards:** a separate optional source-backed section uses warm ivory cards with reviewer avatar, name, review-count detail, amber stars, relative time, and unedited review text. The discreet Google Maps source link follows the list; it never competes with WhatsApp actions.
